...
`define         FUNCT_SP_SLL              6'b000000
`define         FUNCT_SP_MOVCI            6'b000001
`define         FUNCT_SP_SRL              6'b000010
`define         FUNCT_SP_SRA              6'b000011
`define         FUNCT_SP_SLLV             6'b000100
`define         FUNCT_SP_SRLV             6'b000110
`define         FUNCT_SP_SRAV             6'b000111
`define         FUNCT_SP_JR               6'b001000
`define         FUNCT_SP_JALR             6'b001001
`define         FUNCT_SP_MOVZ             6'b001010
`define         FUNCT_SP_MOVN             6'b001011
`define         FUNCT_SP_SYSCALL          6'b001100
`define         FUNCT_SP_BREAK            6'b001101
`define         FUNCT_SP_SYNC             6'b001111
`define         FUNCT_SP_MFHI             6'b010000
`define         FUNCT_SP_MTHI             6'b010001
`define         FUNCT_SP_MFLO             6'b010010
`define         FUNCT_SP_MTLO             6'b010011
`define         FUNCT_SP_MULT             6'b011000
`define         FUNCT_SP_MULTU            6'b011001
`define         FUNCT_SP_DIV              6'b011010
`define         FUNCT_SP_DIVU             6'b011011
`define         FUNCT_SP_ADD              6'b100000
`define         FUNCT_SP_ADDU             6'b100001
`define         FUNCT_SP_SUB              6'b100010
`define         FUNCT_SP_SUBU             6'b100011
`define         FUNCT_SP_AND              6'b100100
`define         FUNCT_SP_OR               6'b100101
`define         FUNCT_SP_XOR              6'b100110
`define         FUNCT_SP_NOR              6'b100111
`define         FUNCT_SP_SLT              6'b101010
`define         FUNCT_SP_SLTU             6'b101011
`define         FUNCT_SP_TGE              6'b110000
`define         FUNCT_SP_TGEU             6'b110001
`define         FUNCT_SP_TLT              6'b110010
`define         FUNCT_SP_TLTU             6'b110011
`define         FUNCT_SP_TEQ              6'b110100
`define         FUNCT_SP_TNE              6'b110110

// Rt : Opcode = RegImm
`define         RT_REGIMM_BLTZ             5'b00000
`define         RT_REGIMM_BGEZ             5'b00001
`define         RT_REGIMM_BLTZL            5'b00010
`define         RT_REGIMM_BGEZL            5'b00011
`define         RT_REGIMM_TGEI             5'b01000
`define         RT_REGIMM_TGEIU            5'b01001
`define         RT_REGIMM_TLTI             5'b01010
`define         RT_REGIMM_TLTIU            5'b01011
`define         RT_REGIMM_TEQI             5'b01100
`define         RT_REGIMM_TNEI             5'b01110
`define         RT_REGIMM_BLTZAL           5'b10000
`define         RT_REGIMM_BGEZAL           5'b10001
`define         RT_REGIMM_BLTZALL          5'b10010
`define         RT_REGIMM_BGEZALL          5'b10011

// Function : Opcode = Special2
`define         FUNCT_SP2_MADD            6'b000000
`define         FUNCT_SP2_MADDU           6'b000001
`define         FUNCT_SP2_MUL             6'b000010
`define         FUNCT_SP2_MSUB            6'b000100
`define         FUNCT_SP2_MSUBU           6'b000101
`define         FUNCT_SP2_CLZ             6'b100000
`define         FUNCT_SP2_CLO             6'b100001

// Rs : Opcode = COP0
`define         RS_COP0_MFC0             5'b00000
`define         RS_COP0_MTC0             5'b00100
`define         RS_COP0_CO               5'b10000

// Function : Opcode = COP0 and Rs = CO
`define         FUNCT_COP0_TLBR            6'b000001
`define         FUNCT_COP0_TLBWI           6'b000010
`define         FUNCT_COP0_TLBWR           6'b000110
`define         FUNCT_COP0_TLBP            6'b001000
`define         FUNCT_COP0_ERET            6'b011000
`define         FUNCT_COP0_WAIT            6'b100000

// Rt: Opcode = CACHE
`define         RT_CACHE_III              5'b00000
`define         RT_CACHE_DIWI             5'b00001
`define         RT_CACHE_IIST             5'b01000
`define         RT_CACHE_DIST             5'b01001
`define         RT_CACHE_IHI              5'b10000
`define         RT_CACHE_DHI              5'b10001
`define         RT_CACHE_DHWI             5'b10101
